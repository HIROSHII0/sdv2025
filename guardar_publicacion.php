...
if (!$titulo) {
    echo json_encode([
        "success" => false,
        "message" => "Falta el campo obligatorio: título."
    ]);
    exit;
}
if (!$descripcion) {
    echo json_encode([
        "success" => false,
        "message" => "Falta el campo obligatorio: descripción."
    ]);
    exit;
}
...
// Insertar con tipo fijo: 'mascota'
$tipo = 'mascota';
...
if ($stmt->execute()) {
    echo json_encode([
        "success" => true,
        "message" => "Publicación de mascota guardada con éxito."
    ]);
} else {
    echo json_encode([
        "success" => false,
